...
import time
a="https://game.granbluefantasy.jp/#quest/supporter/743461/1"
#a="https://game.granbluefantasy.jp/#quest/supporter/711101/1"
...
with sync_playwright() as p:
    ...
    while True:
        ...
        try:
            ...
            while True:
                auto_exists = page.evaluate("""
                () => {
                    return document.querySelector('.btn-auto') !== null;            
                }
                """)

                if not auto_exists:
                    print("AUTO 按钮已消失 → 执行下一步")
                    break
