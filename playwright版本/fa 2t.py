...
import time
a="https://game.granbluefantasy.jp/#replicard/supporter/7/7/15/816131/25/0/25083"
...
with sync_playwright() as p:
    ...
    while True:
        ...
        try:
            ...
            print("跳转1")
            page.wait_for_timeout(1000)
            page.goto("https://game.granbluefantasy.jp/#replicard/stage/7")
            page.wait_for_timeout(1000)
